---
date: '2025-06-15T17:46:22+10:00'
draft: false
...
1. In API Gateway:
    - Click on "API Keys"
    - Generate API key for each team member
2. Under API's Usage Plans:
    - Create new usage plan
    - Add API stage to plan
    - Associate API keys with plan

![](2025-06-15-17-53-18.png)
