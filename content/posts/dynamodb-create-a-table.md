---
date: '2025-06-15T17:15:54+10:00'
draft: false
title: 'Amazon DynamoDB - Create a Table'
tags: ["AWS", "DynamoDB"]
categories: ["Technology"]
---

1. Sign in to AWS Console and navigate to DynamoDB
2. Click "Create table"
    - Table name: e.g., "user_list"
    - Partition key: "user_id (String)
    - Sort key (optional): "first_name" (String)

![](2025-06-15-17-17-38.png)
